      ...
      additionals: [
        {
          ...
          bullets: [
            ...
            {
              main: "데이터 사이언티스트들이 일종의 Python DSL을 통하여 대시보드를 커스터마이징할 수 있도록 Server-driven UI 채택",
              subs: [
                "Dash Framework를 통해 Python 객체 트리가 React 웹 화면을 랜더링됨",
              ],
            },
            {
              main: "Databricks에 여러 쿼리 파라미터들이 포함된 SQL 질의 후 결과를 랜더링 및 캐싱",
              subs: ["Redis TTL 기반 자동 만료 및 수동 무효화 기능 제공"],
            },
            {
              main: "대시보드 화면 구성에 필요한 CMS 및 어드민 기능 제공",
            },
            {
              main: "기여범위: 어드민 기능 전담 및 대시보드 구현 참여, 프로젝트 아키텍쳐 설계 논의에 참여",
            },
          ],
          skills: [
            "Python",
          ...
          images: [
            {
              ...
              caption:
                "이 화면은 실제 지표와는 무관하여, Figma로 프로토타이핑된 모습입니다.",
            },
          ],
        },
        {
          ...
          bullets: [
            ...
            {
              main: "기여범위: 프로젝트 Tech Lead로 참여, 아키텍쳐 설계 및 일정 산정 등 전반적인 프로젝트 관리, HLS streaming 계층을 제외한 모든 백엔드 전담 구현",
            },
          ],
          skills: [
            "Node.js",
        ...
        },
        {
          ...
          bullets: [
            ...
            {
              main: "기여범위: 백엔드 및 어드민 프론트엔드 전체 전담 개발",
            },
          ],
          skills: [
            "Node.js",
        ...
        },
        {
          ...
          bullets: [
            ...
            {
              main: "사전예약자들의 닉네임 및 랜덤하게 생성되는 비주얼의 쿠키 캐릭터 등을 포함한 시민권 이미지를 생성해주는 이벤트 포함",
              subs: [
                "이미지의 생성은 node-canvas를 통해 직접 구현",
                "해당 서버를 프로파일링한 경험을 기술블로그에 게시",
              ],
            },
            {
              main: "기여범위: 이미지 생성 플로우 전담. 사전예약 백엔드 기능 다수 기여",
            },
          ],
          references: [
            {
